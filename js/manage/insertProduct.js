...
$(document).ready(function(){
  handleChangeProductKind();
  $("#productKind").on("change", handleChangeProductKind);
...
function handleChangeProductKind(){
  console.log("handleChangeProductKind");
  $("#productSubKind").html("");
  var mainKindKey = $("#productKind").val();
...
function setSubKind(subKindArr){
  for(var index = 0; index < subKindArr.length; index++ ){
    ...
    $("#productSubKind").append("<option value='"+subCategoryKey+"'>"+subCategoryValue+"</option>")
  }
}
...
function insertSubmit(){
  ...
  var productSubKind = $("#productSubKind").val();
  ...
  console.log("productSubKind : " + productSubKind);
  ...
  formData.append("productSubKind", productSubKind);
